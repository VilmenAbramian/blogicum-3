...
urlpatterns = [
    ...
    path('posts/<int:post_id>/edit/',views.UpdatePostUpdateView.as_view(),name='edit_post'),
    path('posts/<int:post_id>/delete/',views.DeletePostDeleteView.as_view(),name='delete_post'),

    path('posts/<int:post_id>/add_comment/',views.AddCommentCreateView.as_view(), name='add_comment'),
